...
class BackBlazeB2(object):
    def __init__(self, account_id, app_key, mt_queue_size=12,
                 valid_duration=24 * 60 * 60,default_timeout=None):
    ...
    def _authorize_account(self,timeout=None):
    ...
    def list_file_versions(self, bucket_id=None, bucket_name=None, maxFileCount=100, startFileName=None, prefix=None,timeout=None):
        bucket = self.get_bucket_info(bucket_id=bucket_id,
                                      bucket_name=bucket_name,timeout=timeout)
    ...
    def list_file_names(self, bucket_id=None, bucket_name=None, maxFileCount=100, startFileName=None, prefix=None,timeout=None):
        bucket = self.get_bucket_info(bucket_id=bucket_id,
                                      bucket_name=bucket_name,timeout=timeout)
        if maxFileCount > 10000:
            maxFileCount = 10000
